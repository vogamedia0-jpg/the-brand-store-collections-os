...
const boardImage = brandAssets.monogram;
...
function AppLogo({ dark = false }: { dark?: boolean }) {
  return <img src={dark ? brandAssets.logoLight : logo} alt="THE BRAND STORE — LUXURY LIVES HERE." className="tb-logo h-auto w-[190px] max-w-full object-contain" />;
}
...
function AdminLogin() {
  ...
  return <div className="flex min-h-[100dvh] items-center justify-center bg-[hsl(var(--sidebar))] px-5 py-10 text-[hsl(var(--sidebar-foreground))] noise">
    <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/[.06] p-7 shadow-2xl sm:p-10">
      ...
      <p className="mt-3 text-sm leading-6 text-white/60">Sign in to manage the THE BRAND STORE collection.</p>
